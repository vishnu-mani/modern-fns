...
description: "Immutable TypeScript array helpers: chunk, unique, groupBy, indexBy, partition, sortBy, orderBy, zip, range and diffArray. Zero dependencies, tree-shakeable, one import per function."
head:
  - - meta
    - name: keywords
      content: "javascript array utilities, typescript array helpers, groupBy javascript, chunk array"
  - - meta
    - property: og:title
      content: "JavaScript Array Utilities — chunk, groupBy, sortBy, diffArray"
  - - meta
    - property: og:description
      content: "Immutable TypeScript array helpers: chunk, unique, groupBy, indexBy, partition, sortBy, orderBy, zip, range and diffArray. Zero dependencies, tree-shakeable, one import per function."
  - - meta
    - property: og:type
      content: article
---

<!-- Generated from docs/array.md by scripts/sync-docs.mjs. Edit that file, not this one. -->

# JavaScript array utilities

_The `array` module of [modern-fns](/), a dependency-free JavaScript and TypeScript
utility library._
```ts
