...
description: "Manipulate absolute and relative URLs without string surgery: parseUrl, buildUrl, setQuery, mergeQuery, removeQuery, setHash, joinUrl and isSameUrl."
head:
  - - meta
    - name: keywords
      content: "javascript url utilities, add query param to url javascript, join url paths, parse url"
  - - meta
    - property: og:title
      content: "JavaScript URL Utilities — parse, build and edit URLs safely"
  - - meta
    - property: og:description
      content: "Manipulate absolute and relative URLs without string surgery: parseUrl, buildUrl, setQuery, mergeQuery, removeQuery, setHash, joinUrl and isSameUrl."
  - - meta
    - property: og:type
      content: article
---

<!-- Generated from docs/url.md by scripts/sync-docs.mjs. Edit that file, not this one. -->

# JavaScript URL utilities

_The `url` module of [modern-fns](/), a dependency-free JavaScript and TypeScript
utility library._
```ts
